...
describe PgPower::ConnectionAdapters::PostgreSQLAdapter::IndexMethods do
  class PostgreSQLAdapter
    include ::PgPower::ConnectionAdapters::PostgreSQLAdapter::IndexMethods
  end

  let(:adapter_stub) { PostgreSQLAdapter.new }

  it ".supports_partial_index?" do
    expect(adapter_stub.supports_partial_index?).to be_truthy
  end
